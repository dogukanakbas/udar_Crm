PERMISSION_CATALOG = [
    ...
    },
    {
        ...
        "permissions": [
            ...
            ("production.tablet.manage", "İstasyon tabletleri ve üretim PIN'lerini yönet"),
