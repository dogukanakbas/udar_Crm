...
function buildGuideSheet() {
  const rows = [
    ...
    [],
    ['Örnek tablo kolonları', 'Kod, Satış Birimi, Ölçü / Gövde, Renk / Kapak, Miktar, Liste Fiyatı, İskonto 1, İskonto 2, Birim, Birim Net Fiyatı, Tutar'],
  ...
  return [
    {
      ...
      'Tablo Kolonları': 'Kod, Satış Birimi, Ölçü / Gövde, Renk / Kapak, Miktar, Liste Fiyatı, İskonto 1, İskonto 2, Birim, Birim Net Fiyatı, Tutar',
